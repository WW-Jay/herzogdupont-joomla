...
Copyright (C) 2021-2026 Thomas Weidlich
...
The Timeline element is based on the Grid element, Copyright (C) 2016-2026 YOOtheme GmbH. The Flipcard element is based on the Panel element, Copyright (C) 2016-2026 YOOtheme GmbH. The Slideshow Grid element is based on the Grid and Slideshow elements, Copyright (C) 2016-2026 YOOtheme GmbH.
